...
public class Items {
    ...
    public static void init() {
         ...
         */
        ADVANCED_BATTERY = registry.registerItem(_id("advanced_battery"), () -> new AdvancedBattery(CompatibleItemSettings.of(_id("advanced_battery")).addGroup(AdvancedReborn.AR_GROUP).maxCount(1).maxDamage(-1), 8 * TechRebornConfig.redCellBatteryMaxCharge.get(), RcEnergyTier.HIGH));
        ADVANCED_BATTERY_2 = registry.registerItem(_id("advanced_battery_2"), () -> new AdvancedBattery(CompatibleItemSettings.of(_id("advanced_battery_2")).addGroup(AdvancedReborn.AR_GROUP).maxCount(1).maxDamage(-1), 64 * TechRebornConfig.redCellBatteryMaxCharge.get(), RcEnergyTier.HIGH));
        ADVANCED_BATTERY_3 = registry.registerItem(_id("advanced_battery_3"), () -> new AdvancedBattery(CompatibleItemSettings.of(_id("advanced_battery_3")).addGroup(AdvancedReborn.AR_GROUP).maxCount(1).maxDamage(-1), 512 * TechRebornConfig.redCellBatteryMaxCharge.get(), RcEnergyTier.HIGH));
        ADVANCED_BATTERY_4 = registry.registerItem(_id("advanced_battery_4"), () -> new AdvancedBattery(CompatibleItemSettings.of(_id("advanced_battery_4")).addGroup(AdvancedReborn.AR_GROUP).maxCount(1).maxDamage(-1), 4096 * TechRebornConfig.redCellBatteryMaxCharge.get(), RcEnergyTier.HIGH));
        ADVANCED_BATTERY_5 = registry.registerItem(_id("advanced_battery_5"), () -> new AdvancedBattery(CompatibleItemSettings.of(_id("advanced_battery_5")).addGroup(AdvancedReborn.AR_GROUP).maxCount(1).maxDamage(-1), 32768 * TechRebornConfig.redCellBatteryMaxCharge.get(), RcEnergyTier.EXTREME));
        ...
        BATPACK_4 = registry.registerItem(CompatIdentifier.of("better_batpack", "batpack4"), () -> new BetterBatpackItem(betterBatpackSettings.build(CompatIdentifier.of("better_batpack", "batpack4")), TechRebornConfig.lithiumBatpackCharge.get() * 4, new BBArmorMaterial("batpack4"), RcEnergyTier.MEDIUM));
        BATPACK_16 = registry.registerItem(CompatIdentifier.of("better_batpack", "batpack16"), () -> new BetterBatpackItem(betterBatpackSettings.build(CompatIdentifier.of("better_batpack", "batpack16")), TechRebornConfig.lithiumBatpackCharge.get() * 16, new BBArmorMaterial("batpack16"), RcEnergyTier.HIGH));
        BATPACK_64 = registry.registerItem(CompatIdentifier.of("better_batpack", "batpack64"), () -> new BetterBatpackItem(betterBatpackSettings.build(CompatIdentifier.of("better_batpack", "batpack64")), TechRebornConfig.lithiumBatpackCharge.get() * 64, new BBArmorMaterial("batpack64"), RcEnergyTier.EXTREME));
        BATPACK_128 = registry.registerItem(CompatIdentifier.of("better_batpack", "batpack128"), () -> new BetterBatpackItem(betterBatpackSettings.build(CompatIdentifier.of("better_batpack", "batpack128")), TechRebornConfig.lithiumBatpackCharge.get() * 128, new BBArmorMaterial("batpack128"), RcEnergyTier.INSANE));
