    ...
    public static void init() {
        ServerNetworking.registerReceiver(Defines.CARDBOARD_BOX_CLOSE_PACKET_ID.toMinecraft(), (server, player, buf) -> {
            ...
            server.execute(() -> {
                ...
                BlockEntity blockEntity = WorldUtil.getBlockEntity(player.getWorld(), PosUtil.flooredBlockPos(NbtUtil.getDouble(data, "x"), NbtUtil.getDouble(data, "y"), NbtUtil.getDouble(data, "z")));
